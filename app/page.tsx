                ...
                <CardTitle className="flex items-center gap-2">
                  ...
                  {commandQueue.length > 0 && (
                    <Badge variant="secondary" className="ml-2">
                      {commandQueue.length} commands queued
                    </Badge>
                  )}
                </CardTitle>
              </CardHeader>
              <CardContent className="p-0 h-[calc(100%-60px)]">
                <div className="w-full h-full bg-gradient-to-b from-sky-400 to-sky-200 rounded-lg overflow-hidden relative">
                  {executionError && (
                    <div className="absolute top-2 left-2 right-2 z-10 bg-red-500 text-white p-2 rounded text-sm">
